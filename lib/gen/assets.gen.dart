...
class $AssetsLottieGen {
  ...
  /// File path: assets/lottie/history.json
  LottieGenImage get history =>
      const LottieGenImage('assets/lottie/history.json');
  ...
  /// List of all assets
  List<LottieGenImage> get values => [history, home, settings];
}
